...
import b2 from "../../../public/Basalt/B2.jpg"
...
class Title {
  ...
  if (color.a < 0.1) discard;  // Keeps transparency but no blur
  gl_FragColor = color;
}
...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.scale = this.screen.height / 700
...
class App {
  constructor(container, { items, bend, textColor = "#ffffff", borderRadius = 0, font = "bold 30px Poppins" } = {}) {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: "https://res.cloudinary.com/dn1jdxyoq/image/upload/v1741840373/odsq0dpiz2usacvwrnak.jpg", text: 'Bridge' },
      { image: "https://res.cloudinary.com/dn1jdxyoq/image/upload/v1741840371/pk5n5ozp1wvgfagnvwug.jpg", text: 'Desk Setup' },
      { image: "https://res.cloudinary.com/dn1jdxyoq/image/upload/v1741840373/b48d99soq9yyzak7xgtt.jpg", text: 'Waterfall' },
      { image: "https://res.cloudinary.com/dn1jdxyoq/image/upload/v1741840372/heljocujwz8lnxypzrbt.jpg", text: 'Strawberries' },
      { image: b5, text: 'Deep Diving' },
      { image: b6, text: 'Train Track' },
      { image: b7, text: 'Santorini' },
      { image: b8, text: 'Blurry Lights' },
...
export default function CircularGallery({
  ...
  return (
    <>
          ...
          <span className="text-[#fcaf17] pr-[10px]">Influencer</span>
          era 
          </h1>
  
        </div>
    <div className='w-full h-full  !text-[#3131db] mt-[-30px] !font-Poppins overflow-hidden cursor-grab active:cursor-grabbing' ref={containerRef} />
    </>
  )
}
