...
export default function AlertBanner() {
  return (
    <>
      <div className=" md:w-[75%] mx-auto  w-[100%]  mb-[40px] p-4">
        <div className="bg-[#fff] shadow-sm rounded-[20px]  border border-gray-100 md:h-[170px] p-[20px]">
          <div className="flex items-center w-[100%] gap-[12%]">
            <div className="flex items-center  relative gap-6">
             ...
             <i className=" text-[#fff] text-[25px] fa-regular fa-shield-check"></i>
              ...
              <div  className="  absolute text-left gap-[5px] leadeing-[20px]  pt-[6px] justify-start  h-[38px] left-[16px] font-[600] font-Poppins text-[#fff]  pl-[45px] px-[20px] items-  flex flex-col rounded-[20px] text-[14px]  bg-[#ff1a1a] w-[105px]">
