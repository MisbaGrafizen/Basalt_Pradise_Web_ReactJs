...
export default function LifeAt() {
  ...
  return (
    <>
      <div className="md:w-[100%] w-[90%] md:px-[10px] font-Poppins flex mx-auto">
        <div className="flex  flex-col  gap-[30px] justify-between relative w-[100%]">
          ...
          <div className="border border-gray-200 flex flex-col gap-[30px] rounded-lg overflow-hidden">
            ...
            <div className=" flex  md:flex-row flex-col justify-center items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">life_at_Basalt_pradise</p>
              </div>
            </div>
