      ...
      <div className="w-[100%] px-[15px] pb-[30px] font-Poppins flex mx-auto">
        <div className="flex justify-between relative gap-[19px] flex-col w-[100%]">
          ...
          <p className="  flex  text-center justify-center w-[95%] text-[#515151] mx-auto md:text-[17px]  ">
            ...
            moment at our resort is nothing short of magical. From visionary
            planners to hospitality experts, they are the architects of a
            retreat where every guest feels special. Come, join us in
            celebrating the beauty of nature, impeccable service, and the
            extraordinary team that makes Basalt Paradise Resort a true
            paradise.
          </p>
        </div>
      </div>
