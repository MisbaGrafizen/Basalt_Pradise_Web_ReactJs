...
export default function SeasonalSpa() {
                ...
                <div className=" md:w-[80%] gap-[40px] flex flex-col">
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] flex items-center gap-[10px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                            ...
                            Summer: Cooling Relief in the Heat
                        </h1>
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Halol summers are warm and sunlit, and the spa embraces that with refreshing therapies. Cooling cucumber facials hydrate sun-kissed skin, while aloe vera wraps help calm and restore. Herbal waters infused with mint and basil are offered post-treatment, leaving guests refreshed and energized. It’s like sipping shade on a hot day—soft, cooling, and restorative.                            </p>
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
                            Monsoon: Botanical Comforts in the Rain                        </h1>
                        {/* Hero Banner */}
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={praragavhill1}
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                When the rains arrive, everything at Basalt Paradise slows down into a rhythm of comfort. The spa celebrates this season with botanical infusions—steamy tulsi foot baths, warm oil therapies, and gentle exfoliation using natural scrubs made from local herbs. Guests often describe the monsoon treatments as “rain in reverse”—instead of soaking from the outside, you’re cocooned in warmth from within.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
...
Winter: Warmth in Every Touch
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                As the air turns crisp and mornings glow golden, the spa leans into grounding rituals. The signature basalt stone massage, using warm stones sourced locally, is a favorite. Combined with spiced oils—ginger, cinnamon, and clove—it melts away tension and recharges the body. Guests say it feels like carrying the fire of Halol’s winter evenings back into their bones.
                            </p>
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
Why Seasonal Treatments Matter
                        </h1>
                        {/* Hero Banner */}
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                             Wellness at Basalt Paradise isn’t static—it flows with nature. Each ritual is carefully designed to balance what your body craves at that time of year. Cooling in summer, comforting in monsoon, warming in winter—the treatments are as much about tuning into yourself as they are about relaxation.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] flex items-center gap-[10px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
A Spa Experience Rooted in Place
                        </h1>
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={FlyingBird1}
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                               Unlike generic spas, the therapies here are deeply tied to Halol’s local climate and natural ingredients. Guests often share that these seasonal rituals stay with them long after their stay—be it a habit of sipping herbal tea in the rain, or practicing warm oil massages during chilly days at home.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
