...
import blog1 from "../../../public/NewDriveImage/mainfull.jpg";
import blog11 from "../../../public/NewDriveImage/mainfront.jpg";
import blog111 from "../../../public/NewDriveImage/nightgreen1.jpg";
import flyingBird1 from "../../../public/NewDriveImage/nightswimmingpool.jpg";
import flyingBird2 from "../../../public/NewDriveImage/nightswimmingpool.jpg";
...
export default function BasaltByDay() {
...
Morning: Sun-Dappled Beginnings                        </h1>
...
Mornings at Basalt Paradise arrive gently. The first light filters through mist and trees, casting long, golden shadows across the pathways. Birds echo in the background while guests sip steaming chai by the dew-kissed garden. The villas, designed with wide windows and open views, invite in that soft radiance, making every morning feel like a private sunrise show.
                            </p>
...
Afternoon: Glowing & Alive
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
By afternoon, the resort comes alive in full light. The pool sparkles like liquid sapphire, the gardens look impossibly green, and the open courtyards breathe with warmth. Families gather for outdoor games, while some retreat to shaded corners with books and cool drinks. The bright daylight heightens every color, making Basalt Paradise feel both energetic and restorative—a balance that lingers with guests long after they leave.                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
...
Evening: The Soft Fade                        </h1>
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
As the sun lowers, the resort transforms. Golden light spills across the terraces, soft breezes carry the scent of blooming flowers, and guests gather near the poolside for conversations that stretch until twilight. This is the “pause” moment of the day—when Basalt Paradise slows down, inviting guests to breathe deeper and notice the beauty in transition.                            </p>
...
Night: Stars & Stillness
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
When night arrives, Basalt Paradise becomes a different world. Pathways glow with warm lanterns, villas shimmer under moonlight, and the pool reflects the stars like glass. Guests often end their evenings with stargazing from their balconies or sharing stories by candlelight dinners. Many describe this as the most magical part of their stay—the feeling of being connected to something vast and timeless.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                      <h1 className="text-[18px] flex items-center gap-[10px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                         <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
Light as a Living Experience                        </h1>
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={FlyingBird2}
                                onClick={() => openLightbox(FlyingBird1)}
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
What makes Basalt Paradise truly unique is how it embraces natural light. Every hour of the day is designed to be felt, whether it’s a sunbeam warming your shoulders in the garden or moonlight guiding you to your villa. Guests don’t just see the resort—they sense it.
                           </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
