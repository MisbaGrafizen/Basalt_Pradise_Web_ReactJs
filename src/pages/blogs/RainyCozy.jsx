...
export default function RainyCozy() {
            ...
            <div className="  2xl:w-[1300px] font-Poppins !bg-[#] w-[90%] md:w-[80%]   h-[100%] mx-auto px-2 py-8 gap-[20px] pt-[110px] flex ">
                <div className=" md:w-[80%] gap-[40px] flex flex-col">
                     ...
                     <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                There’s something deeply comforting about watching the rain from a dry, warm corner.
                            </p>
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                At Basalt Paradise, every villa has its own window story—some frame the forest in soft grey mist, others overlook garden trails slowly being washed clean. The rhythm of rainfall against glass becomes your background music, pairing perfectly with :
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li>A steaming cup of masala chai or French press coffee</li>
                                <li> Your current read or a journal waiting for fresh thoughts</li>
                                <li>Just… stillness. No agenda. No rush.</li>
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
                         Board Games, Books & Laughter Indoors
                        </h1>
                        {/* Hero Banner */}
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                When clouds gather thick and the outside turns dramatic, the inside comes alive with warmth.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                           Our indoor lounge areas become intimate spaces where strangers become friends, families rediscover each other, and laughter echoes louder than thunder. Curl up on plush sofas with :
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li>Classic board games like Scrabble, Uno, and chess</li>
                                <li> Our curated library of fiction, nature writing, and travel tales</li>
                                <li>Card games and quiet corners for mindfulness coloring or journaling</li>
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                              Once the downpour softens to a drizzle, step outside.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
The earth smells rich, almost sweet. Trees drip quietly. Leaves glisten. Our garden paths, lined with basalt stone and shaded by gulmohar and neem, turn into peaceful sanctuaries.
                            </p>
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li>Tiny frogs hopping from one puddle to another </li>
                                <li>Earthworms crawling across leaf-strewn paths</li>
                                <li>Peacocks enjoying the weather, sometimes dancing in the open</li>
...
We encourage guests to take their shoes off and walk barefoot—it’s grounding in the best way.
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
                          Indoor Bonfires & Candlelit Conversations
                        </h1>
                        {/* Hero Banner */}
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
One of the most beloved experiences at Basalt Paradise during monsoon? The indoor bonfire evenings.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                               Set inside our open community lounge (with high ceilings and warm wood interiors), we host candle-lit hours with :
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li>Light instrumental music in the background</li>
                                <li> Hot pakoras, roasted peanuts, and herbal teas</li>
                                <li>Stories shared across generations, in multiple languages</li>
                                <li>Board games stretched out beside flickering shadows</li>
                                {/* <li>Nature’s own lullaby as you fall asleep</li> */}
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                     <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                           ...
                           Why Monsoon at Basalt Isn’t Just a Season—It’s a Mood
                        </h1>
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={FlyingBird1}
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li>You get nature at its most romantic, wild, and intimate</li>
                                <li>It’s a time when fewer crowds mean deeper silence</li>
                                <li>Every corner of the resort feels more alive—with mist, music, and magic</li>
                    ...
                    <div className=" w-[100%]">
                       <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li>"We came to escape the city’s chaos, but the monsoon made us fall in love with stillness."</li>
                                <li>  "I had forgotten what it feels like to get excited about rain. Here, it felt like poetry."</li>
                                <li>"We played board games with our kids for the first time in months. It was the best gift."</li>
