...
export default function ColorOfHalol() {
                ...
                <div className=" md:w-[80%] gap-[40px] flex flex-col">
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                As the first raindrops kiss the earth, the resort awakens in layers of green.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Bright lime creeps over stone walls.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Deep emerald curtains fall from the treetops.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Young saplings peek through the soil like watercolors on damp paper.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                The air is soft.                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Ferns lean in, heavy with rain.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                It’s a world where everything feels fresh, almost reborn.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Misty mornings become slow affairs. Guests wrap their hands around warm chai cups while watching clouds dance over the hills. Even silence sounds different here—softer, wetter, more alive.
                            </p>
                        </article>
                    </div>
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                As the rains retreat, a gentle golden tone takes over.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                The grasses dry into wheat-colored carpets.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                The trees shift to muted olives and browns, brushing the landscape with a painter’s restraint.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Sunlight turns amber.
                            </p>
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Evenings are cooler—perfect for bonfires and hot soup under the stars.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                The villas catch the golden hour light just right, casting warm glows on wooden textures and terracotta tiles. Guests tuck into shawls, sip mulled drinks, and slow down with stories beside firepits. It’s a time of reflection, coziness, and quiet joy.
                            </p>
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Spring sneaks in with bursts of brightness.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Bougainvillaeas bloom in unapologetic pinks and purples.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Wildflowers dot the pathways in playful clusters.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Even the skies feel bluer.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                There’s a sense of lightness, movement, and joy.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Children run barefoot on the lawns.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Couples read under flowering trees.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                The kitchen serves citrus salads and garden-picked mint teas.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                It’s a season of energy and renewal—and the entire resort hums with it.
                            </p>
                            {/* <div className="!mt-[10px]">
                                <b className="font-[600]  text-[#7442ff]">Tip:</b> Book a valley-facing villa to catch the best morning views, especially in July and August.
                                <br /></div> */}
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                The summer palette is more minimal, but no less beautiful.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Soft beiges, bleached stone, terracotta earth.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                The trees wear lighter greens. The sky is vast and bright. Shadows stretch lazily.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Guests spend more time in the pool, under wide-brimmed hats, sipping chilled coconut water. Hammocks sway gently in the breeze. The pace slows, matching the rhythm of the sun.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Summer at Basalt is about light: not just sunlight, but emotional lightness too.
                            </p>
                            {/* <div className="!mt-[10px]">
                                <b className="font-[600]  text-[#7442ff]">Tip:</b> Book a valley-facing villa to catch the best morning views, especially in July and August.
                                <br /></div> */}
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                At Basalt Paradise, the seasons aren’t just weather—they’re moods.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                They shape your morning view, the food on your plate, the smell of the air, and the way you sleep at night.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Some guests come back in different seasons just to feel the shift.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                To see how the same bench by the banyan tree looks under grey clouds… or golden light… or pink blooms.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Because here, color is not a background. It’s part of the story.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                And no two visits ever feel the same.                            </p>
                    ...
                    {/* <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                What makes Basalt Paradise special isn’t just the view or the villas—it’s the feeling. That sense of being held, soothed, and restored.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
