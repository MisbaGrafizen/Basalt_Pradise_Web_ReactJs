...
export default function OfflineEscape() {
                ...
                <div className=" md:w-[80%] gap-[40px] flex flex-col">
                       ...
                       <h1 className="text-[18px] flex items-center gap-[10px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                You wake up to soft light seeping through sheer curtains, the smell of fresh earth after last night’s drizzle, and the sound of birds—not alarm clocks.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                No buzzing phones, no urgent emails. Just you, the sunrise, and maybe a journal.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Take your first tea on the porch. Let the stillness settle. Let your mind wander. You don’t need to document this moment—just live it.                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Instead of swiping through reels, try a slow yoga flow facing the trees. Or simply stretch on the grass, barefoot and grounded.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Your mind begins to slow its pace. Ideas come gently—not in push notifications, but in the rhythm of your breath and birdsong.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                And if you crave activity? There are nature trails waiting to be explored. Trees to greet. Stones to sit on and just… be.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                                What you need :
                            </p> */}
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Lunch isn’t eaten with one hand holding a phone. It’s slow. Fresh. Warm.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Whether you’re with a partner, family, or traveling solo, meals here spark real connection. Laughter replaces background TV noise. Conversations take their time. You look up and realize—you haven’t checked your phone once.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                As golden hour glows across the valley, you settle into a book. Or maybe you pick up an old-school board game from the lounge—Scrabble, Uno, Chess.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                The kids giggle without screens. Couples tease each other over a game of cards. No selfies, no filters, just memories in the making.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                And just like that, time stretches beautifully.
                            </p>
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                After dinner, you step out.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                The sky is endless. No city lights. Just a canopy of stars and the soft murmur of night insects. You lie back on a charpai or walk barefoot to the fire pit.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                There’s no urge to grab your phone.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Because what could a screen show you that the sky isn’t already offering?
                            </p>
                    ...
                    <div className=" w-[100%]">
                       <h1 className="text-[18px] flex items-center gap-[10px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li>“I didn’t realize how addicted I was to my phone until I spent a day without it.”</li>
                                <li>  “My child forgot about their iPad for the first time in years.”</li>
                                <li> “I remembered what quiet felt like—and I missed it.”</li>
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li><b>Journaling
                                </b> instead of Instagramming</li>
                                <li><b>Real eye contact
                                </b>instead of screen time</li>
                                <li><b>Exploring nature
                                </b> instead of apps</li>
                                <li><b>Sleeping deeply
                                </b> instead of doomscrolling</li>
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                You don’t have to escape to escape technology.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                You just need the right place to remember what being human feels like.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <b>Basalt Paradise isn’t just Wi-Fi-free—it’s worry-free.
                                </b>
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                And one unplugged day here might just recharge you more than any power bank ever could.
                            </p>
                            {/* <b className="font-[600] !mt-[10px] text-[#7442ff]">Don't miss: </b>  Homemade laddoos sold by temple-side vendors – perfect post-darshan treat! */}
