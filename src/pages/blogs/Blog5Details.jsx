                ...
                <div className=' md:w-[80%] gap-[40px] flex flex-col'>
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            <h1 className="text-[18px] md:text-[23px] font-[500] text-gray-900">
                                Trekking to Pavagadh Hill – Conquer the Heights!
                            </h1>
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Pavagadh Hill is an ancient volcanic formation, offering one of the best trekking experiences in Gujarat. The trail to Kalka Mata Temple is filled with lush greenery, rocky paths, and stunning viewpoints that make the climb totally worth it!
                            </p>
                            <div className='  flex mt-[10px] flex-col gap-[6px]'>
                                ...
                                <div className=' flex gap-[10px] '>
                                    ...
                                    <div className=' items-center flex gap-[8px]'>
                                        <h1 className=' font-[500] text-[16px]'>
                                            Scenic sunrise & breathtaking views
                                        </h1>
                                ...
                                <div className=' flex gap-[10px] '>
                                    ...
                                    <div className=' items-center flex gap-[8px]'>
                                        <h1 className=' font-[500] text-[16px]'>
                                            A thrilling 2.5 km uphill climb
                                        </h1>
                            ...
                            <div className=' cursor-default pt-[10px] flex md:items-center gap-[10px]   '>
                                ...
                                <p className=' md:flex items-center  gap-[10px] mt-[2px] '>
                                    <b className=' text-[18px] font-[600] te'> Best Time to Visit : </b> <p className=' flex font-[500]'>Early morning or evening</p>
                                </p>
                            </div>
                    ...
                    <div className=" w-[100%]">
                        ...
                        <div className=' cursor-default mb-[10px] flex items-center gap-[10px]   text-[#7442ff] '>
                            <i className="fa-regular text-[20px ] fa-location-dot"></i>
                            <p className=' gap-[10px] mt-[2px] flex'>
                                <b className=' md:text-[18px] font-[400]'>Pavagadh Adventure Park</b>
                            </p>
                        </div>
                        {/* Main Content */}
                        <article className="space-y-2">
                            <h1 className="text-[18px] md:text-[23px] font-[500] text-gray-900">
                                Paragliding in Pavagadh – Fly Like a Bird!
                            </h1>
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Did you know you can paraglide over the beautiful landscapes of Pavagadh? Experience the thrill of soaring high above the lush greenery with a certified instructor.
                            </p>
                            <div className='  flex mt-[10px] flex-col gap-[6px]'>
                                <h1 className=' flex font-[600] mt-[10px] text-[20px] basalt-text'>
                                    Why Try It?
                                ...
                                <div className=' flex gap-[10px] '>
                                    ...
                                    <div className=' items-center flex gap-[8px]'>
                                        <h1 className=' font-[500] text-[16px]'>
                                            Unique adventure activity in Gujarat
                                        </h1>
                                ...
                                <div className=' flex gap-[10px] '>
                                    ...
                                    <div className=' items-center flex gap-[8px]'>
                                        <h1 className=' font-[500] text-[16px]'>
                                            Mesmerizing aerial views of the region
                                        </h1>
                            ...
                            <div className=' cursor-default pt-[10px] flex md:items-center gap-[10px]   '>
                                <i className="fa-regular  md:mt-0 mt-[6px] text-[#7442ff] fa-calendar-days"></i>
                                <p className=' md:flex items-center  gap-[10px] mt-[2px] '>
                                    <b className=' text-[18px] font-[600] te'> Best Time to Visit : </b> <p className=' flex font-[500]'>October – March</p>
                                </p>
                            </div>
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            <h1 className="text-[18px] md:text-[23px] font-[500] text-gray-900">
                                Camping & Bonfire in Jambughoda Wildlife Sanctuary
                            </h1>
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                If you love the outdoors, spend a night under the starry sky at Jambughoda Wildlife Sanctuary. Enjoy a campfire, jungle safari, and night trails to spot exotic wildlife like leopards, sloth bears, and deer.
                            </p>
                            <div className='  flex mt-[10px] flex-col gap-[6px]'>
                                <h1 className=' flex font-[600] mt-[10px] text-[20px] basalt-text'>
                                    Why Try It?
                                ...
                                <div className=' flex gap-[10px] '>
                                    ...
                                    <div className=' items-center flex gap-[8px]'>
                                        <h1 className=' font-[500] text-[16px]'>
                                            Ideal for group trips & families
                                        </h1>
                            ...
                            <div className=' cursor-default pt-[10px] flex md:items-center gap-[10px]   '>
                                <i className="fa-regular  md:mt-0 mt-[6px] text-[#7442ff] fa-calendar-days"></i>
                                <p className=' md:flex items-center  gap-[10px] mt-[2px] '>
                                    <b className=' text-[18px] font-[600] te'> Best Time to Visit : </b> <p className=' flex font-[500]'>November – February</p>
                                </p>
                            </div>
