...
export default function History() {
    ...
    return (
            ...
            <div className='  2xl:w-[1300px] font-Poppins !bg-[#] w-[90%] md:w-[80%]   h-[100%] mx-auto px-2 py-8 gap-[20px] pt-[110px] flex '>
                ...
                <div className=' md:w-[80%] gap-[40px] flex flex-col'>
                    ...
                    <div className=" w-[100%]">
                        ...
                        History of Champaner-Pavagadh – A Heritage Explorer’s Guide                        </h1>
                        ...
                        <article className="space-y-2">
                            ...
                            Tucked in the Aravalli foothills near Halol lies a treasure trove of forgotten dynasties, Islamic architecture, Hindu shrines, and centuries-old stepwells — all waiting to be discovered.                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Welcome to Champaner-Pavagadh, Gujarat’s only UNESCO World Heritage Site and one of India’s most underrated heritage gems. If you’re a history buff, culture lover, or curious traveler — this is your ultimate guide.</p>
                    ...
                    <div className=" w-[100%]">
                    <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                    Where is Champaner-Pavagadh?                        </h1>
                        {/* Hero Banner */}
                        <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Located about 55 km from Vadodara and just 7 km from Halol, the Champaner-Pavagadh Archaeological Park spans a huge area of ancient ruins, active temples, and forested hills. The region combines two historically significant areas:
                            </p>
                            <div className="">
                <b className="font-[600] text-[#7442ff]">Pavagadh Hill: </b>{" "}
             A sacred hill known for Kalika Mata Temple and prehistoric settlements.
               <br />
                <b className="font-[600] text-[#7442ff]">Champaner City:</b>{" "}
               A fortified 15th-century Islamic city founded by Sultan Mahmud Begada.
                    ...
                    <div className=" w-[100%]">
                    <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                    Timeline of Champaner-Pavagadh</h1>
                        {/* Hero Banner */}
                        <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={FlyingBird[currentIndexFlying]}
      ...
      <p className="text-gray-600 md:text-[16px] text-[14px]">
               ...
               Pavagadh becomes a major Hindu spiritual center, home to Shaivite and Jain temples.
              ...
              <div className="">
                <b className="font-[600] text-[#7442ff]">1484 AD:  </b>{" "}
               Mahmud Begada, Sultan of Gujarat, captures the region and makes Champaner his capital.
                
              </div>
              <div className="">
                <b className="font-[600] text-[#7442ff]">1536 AD: </b>{" "}
               Mughal invasion under Humayun leads to the decline of Champaner’s political relevance.
              </div>
              <div className="">
                <b className="font-[600] text-[#7442ff]">2004: </b>{" "}
                UNESCO recognizes it as a World Heritage Site.
                    ...
                    <div className=" w-[100%]">
                    <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                    What Makes It a UNESCO Site?</h1>
                        {/* Hero Banner */}
                        <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <div className="">
                <b className="font-[600] text-[#7442ff]">Champaner-Pavagadh is one of the only places in India that offers:</b>{" "}
                A complete Islamic pre-Mughal city preserved in its original layout
              
               Unique blend of Hindu, Jain, and Islamic architecture
               
            Continuously inhabited sacred sites from prehistoric to modern times
               
                Incredible examples of urban planning, stepwell engineering, and religious tolerance
                    ...
                    <div className=" w-[100%]">
                    <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                    Major Attractions (And What to Look For)</h1>
                        {/* Hero Banner */}
                        <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={kadaDamMain[currentIndexkada]}
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Kalika Mata Temple</p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Still a highly active pilgrimage site atop Pavagadh Hill</p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Originally a tribal shrine, now a symbol of religious fusion</p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Jami Masjid</p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Possibly the most beautiful mosque in Gujarat</p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Features lotus motifs, domes, minarets, and jalis</p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Saat Kaman </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Arched military structure offering panoramic views of the plains below</p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Built for strategic lookout over the kingdom</p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Nagina Masjid & Kevda Masjid</p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                            Lesser-known but equally stunning mosques surrounded by gardens</p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
              ...
              Basalt Paradise’s outdoor seating and natural landscaping look even more beautiful under rain.
                 */}
                    ...
                    <div className=" w-[100%]">
                    <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                    Best Way to Explore the Site</h1>
                        {/* Hero Banner */}
                        <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={kadaDamMain[currentIndexkada]}
                        ...
                        <article className="space-y-2">
                           ...
                           <p className="text-gray-600 md:text-[16px] text-[14px]">
                           Start from Pavagadh Hill (Kalika Mata Temple) in the early morning</p>
                           <p className="text-gray-600 md:text-[16px] text-[14px]">
                           Descend into the Champaner plains to explore mosques and wells</p>
                           <p className="text-gray-600 md:text-[16px] text-[14px]">
                           
Carry water, wear comfortable shoes, and take a local guide if possible</p>
                            <div className='  flex mt-[10px] flex-col gap-[6px]'>                           </div>
                            <div className="f">
...
<li>June–September (monsoon mists + great for photos, but more slippery paths)</li>
                    ...
                    Where to Stay?</h1>
                        ...
                        <article className="space-y-2">
                           ...
                           Make your base at Basalt Paradise – a beautiful nature retreat near Halol that blends modern comforts with rustic tranquility. Just 15–20 minutes from all heritage spots.</p>
                    ...
                    Final Word:</h1>
                        ...
                        <article className="space-y-2">
                           ...
                           <p className="text-gray-600 md:text-[16px] text-[14px]">
                           Champaner-Pavagadh isn’t just a stop on your Gujarat itinerary — it’s an open-air museum of India’s multicultural past. The ruins may be silent, but the stories they whisper are timeless.</p>
                           <p className="text-gray-600 md:text-[16px] text-[14px]">
                           Whether you’re coming for spiritual peace, historical awe, or simply the Insta-worthy architecture — this heritage site will leave a mark on your soul.</p>
                            <div className='  flex mt-[10px] flex-col gap-[6px]'>
