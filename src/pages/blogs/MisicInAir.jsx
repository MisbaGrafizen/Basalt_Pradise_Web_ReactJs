...
export default function MusicInAir() {
...
One of the first things guests notice is the soundscape. Mornings begin with birdsong, each call layering over the rustle of trees. By afternoon, the breeze sweeps through the gardens, whistling gently across leaves and flowers. Come evening, the hum of crickets and the chirp of night creatures take over, wrapping the resort in calm.
                            </p>
...
It isn’t silence—it’s music, played by the earth itself.
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
Bamboo, Streams, and Garden Whispers
                        </h1>
                        {/* Hero Banner */}
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Wander through the pathways, and you’ll hear the bamboo groves whispering in rhythm with the wind. A small stream nearby adds its own melody—soft ripples that echo like laughter. Even the footsteps on stone and wood seem to add to this natural orchestra, reminding you that every movement here belongs to a larger harmony.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                      ...
                      Local Sounds, Local Soul
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                               At Basalt Paradise, the connection to sound goes beyond nature. Evenings at the open lounge often feature local musicians, whose instruments and voices blend seamlessly with the setting. A soft tabla rhythm or a soulful folk song drifting across the poolside feels less like a performance and more like part of the environment—authentic, warm, and deeply grounding.
                            </p>
...
Why Sound Matters
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                               Sound has a subtle yet powerful influence on relaxation. Guests often describe how the ambient music of Basalt Paradise helps them feel lighter, calmer, and more present. Unlike city noise that demands attention, the resort’s sounds invite you to slow down, listen, and simply be. It’s wellness in its purest form, delivered through the ears.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
...
The Takeaway Tune
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                              Every stay at Basalt Paradise carries a memory, and for many, it isn’t just the visuals but the soundtrack that stays with them. The birds, the streams, the bamboo, and the music of Halol—it’s all part of the melody of the resort.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
