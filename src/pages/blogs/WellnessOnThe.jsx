...
export default function WellnessOnThe() {
                ...
                <div className=" md:w-[80%] gap-[40px] flex flex-col">
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            ...
                            The 5-5-5 Breathing Ritual: Center Yourself in a Minute
                        </h1>
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Inspired by our early morning meditation sessions under the neem trees, this is your pocket-friendly pause button.
                            </p>
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            ...
                            Herbal Foot Soak at Home: Grounding from the Ground Up
                        </h1>
                        {/* Hero Banner */}
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Remember those warm foot baths we welcome you with at the spa? You can recreate that same indulgence at home—using simple ingredients from your kitchen.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
                            Nature Stretch Flow: Move Like the Trees
                        </h1>
                        {/* Hero Banner */}
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                One of our guests’ favorite activities at Basalt Paradise is the sunrise stretch near the lawns—gentle, flowing movements that mimic nature. You don’t need fancy gear or an instructor—just intention and breath.                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li>Neck rolls (slow circles, both directions)</li>
                                <li>Shoulder shrugs and releases</li>
                                <li>Cat-cow seated (gentle spine stretches while seated on a chair)</li>
                                <li>Seated forward fold</li>
                                <li>Wrist and ankle rotations</li>
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Each move invites circulation, clarity, and calm. Try it in the morning or after a long day on the screen.
                            </p>
                            {/* <div className="!mt-[10px]">
                                <b className="font-[600]  text-[#7442ff]">Tip:</b> Book a valley-facing villa to catch the best morning views, especially in July and August.
                                <br /></div> */}
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
                            Chai Time Stillness: Sip and Slow Down
                        </h1>
                        {/* Hero Banner */}
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                At Basalt Paradise, chai is never rushed. It’s served slowly, sipped mindfully, often in silence with the sound of rain or birds in the background.
</p>
...
//                             </p> */}
                    ...
                    <div className=" w-[100%]">
                      <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
                            Bedtime Oil Ritual: Soften Into Sleep
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Before our nighttime spa rituals, we often apply warm oil to the feet and temples—an ancient practice known to promote deep sleep and calm the nervous system.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                DIY version :                               </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li>Warm a teaspoon of sesame or coconut oil</li>
                                <li>Gently massage it into your soles and temples</li>
                                <li>Add a drop of lavender or chamomile essential oil if available</li>
                                <li>Slip into bed and let your body melt into rest</li>
