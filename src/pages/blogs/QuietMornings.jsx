...
export default function QuietMornings() {
                ...
                <div className=" md:w-[80%] gap-[40px] flex flex-col">
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Before the sun peeks out, a soft mist hugs the surrounding hills and trees like a warm blanket. You open your villa doors to this dreamy view—clouds drifting at eye level, dewdrops resting on every leaf, and the distant sound of nature stretching awake.
                            </p>

                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                No honks, no alarms. Just the crisp scent of earth after a cool night and the occasional chirp of a bird starting its morning chorus.
                            </p>
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            ...
                            Tea in Hand, Worries Out the Window
                        </h1>
                        {/* Hero Banner */}
                        <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                There’s a ritual that feels almost sacred here: stepping out onto your private balcony with a warm cup of chai or coffee. The steam rising from your cup dances with the mist. You wrap your fingers around the mug, take a slow sip, and exhale deeply.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Around you, everything is still. Maybe you hear the distant laughter of a peacock, or the breeze rustling through tall grass. Some guests journal, others meditate. Many just sit—doing absolutely nothing—and realize how long it’s been since they allowed themselves to just be.                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                No rush. No itinerary. Just you and the slow, golden unfolding of daybreak.
                            </p>
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                If you’re looking to center yourself, there’s no better time. Join a sunrise yoga session on our open-air platform, where every stretch feels deeper and every breath feels more alive. With the sky slowly brightening above and the earth still cool below, it's an experience that connects you to the present moment in the purest way.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Or take a quiet walk along the trail, barefoot if you’d like, letting the textures of earth and gravel bring you back to yourself. It’s not about exercise—it’s about awakening, gently.
                            </p>
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                As the sun rises a little higher, it brings with it the smell of breakfast. At Basalt Paradise, even food honors the mood of the morning—wholesome, comforting, and made with love.
                            </p>
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                Expect seasonal fruit platters, soft parathas or the occasional surprise local delicacy, fluffy idlis, or your favorite kind of eggs. There’s always something warm, something sweet, and something refreshing.
                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                No breakfast buffet rush. No crowd. Just peaceful plates, happy faces, and that gentle buzz of a day beginning right.
                            </p>
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                            Why Mornings at Basalt Feel Like a Hug from Nature
                        </h1>
                        <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={FlyingBird1}
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li>Spacious villas with large windows that welcome sunrise light</li>
                                <li> Natural soundscape—birds, breeze, and nothing in between</li>
                                <li>In-room tea/coffee moments with a view of mist-covered hills</li>
                    ...
                    <div className=" w-[100%]">
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                                <li>"I never knew I could feel so calm just by watching the mist roll by."</li>
                                <li> "It’s the kind of morning that makes you want to write poetry—or at least pause and smile."</li>
                                <li>"I woke up early every single day—and I’ve never done that on a vacation before."</li>
                                {/* <li>Option for yoga or solitude without leaving your villa</li>
                                <li>Freshly cooked breakfast at your pace, in your space</li> */}
                            </p>
                            {/* <b className="font-[600] !mt-[10px] text-[#7442ff]">Don't miss: </b>  Homemade laddoos sold by temple-side vendors – perfect post-darshan treat! */}
