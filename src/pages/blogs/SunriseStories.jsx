...
import blog1 from "../../../public/VilaNewImages/villa5.jpeg";
import blog11 from "../../../public/NewDriveImage/area1.jpg";
import blog111 from "../../../public/NewDriveImage/graden.jpg";
...
export default function SunriseStories() {
...
For some, mornings begin with a steaming cup of chai by the pool. As the first rays of sunlight touch the rippling water, guests describe the scene as nothing short of cinematic. “The quiet was so deep, I could hear my own thoughts,” one guest reflected. The resort’s serene morning atmosphere often inspires a slow start—sipping tea, watching the mountains glow, and easing into the day without rush.
                            </p>
...
Pink Skies and Morning Walks
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
A favorite ritual among nature lovers is walking along the gardens just as the sky blushes pink. Guests recall the soft crunch of gravel underfoot, the scent of wet earth, and the distant call of birds. These walks often turn into moments of self-reflection—some journal, some meditate, and others simply breathe deeply, enjoying the fresh mountain air near Halol.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
...
Yoga with a View
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Many guests turn mornings into opportunities for wellness. Unrolling mats on terraces or in quiet garden corners, they find stillness through yoga and guided breathing. The blend of wellness and nature at Basalt Paradise makes it easier to disconnect from distractions and reconnect with oneself. As one guest put it, <b>“The silence wasn’t empty—it was full of presence.”</b> 
                            </p>
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            {/* <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i> */}
Slow Breakfasts, Long Conversations
                        </h1>
                        {/* Hero Banner */}
                        <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Mornings often end with an unhurried breakfast shared with family or fellow travelers. Plates filled with warm local flavors, the laughter of children, and easy conversations set the tone for the day. Guests often remark how these family-friendly mornings in Gujarat resorts give them space to truly connect—with loved ones and with themselves.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                      <h1 className="text-[18px] flex items-center gap-[10px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                         {/* <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i> */}
Why Guests Treasure the Sunrise at Basalt Paradise
                        </h1>
                        <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={FlyingBird2}
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Every sunrise here feels like a ritual. Some capture it in photos, some sketch it in notebooks, and others carry it in memory. The blend of natural beauty, calm surroundings, and personal rituals make mornings at this resort near Vadodara uniquely unforgettable.                            </p>
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
It’s not just about watching the sun rise—it’s about how those quiet hours make you feel. As one guest beautifully summed up, “I arrived tired, but every morning here gave me back a piece of myself.”
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
