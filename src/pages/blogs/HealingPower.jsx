...
Basalt rock is naturally dense and heat-retentive, which is why it’s used in spa therapies worldwide. At Basalt Paradise’s spa, warmed basalt stones ease tense muscles, improve circulation, and invite a sense of deep relaxation. Guests often describe this therapy as a “reset button”—one that melts away urban stress and reconnects body to earth.
                            </p>

                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
It isn’t silence—it’s music, played by the earth itself.
                            </p> */}
...
A Texture That Grounds You
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Unlike polished marble or glossy tiles, basalt carries a matte, earthy texture. Walking barefoot across basalt pathways at the resort connects you directly with the land. This sensory experience—often called “earthing”—is known to calm the nervous system and restore balance, reminding guests that wellness begins beneath their feet.
</p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
              ...
              Architecture Rooted in Nature
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
The resort’s design celebrates basalt not just as stone, but as a presence. Walls, courtyards, and open terraces use it to frame light and shadow. In the heat of summer, basalt’s cooling qualities temper the air; in cooler months, it stores warmth from the sun. This quiet partnership with nature is what makes the resort feel both grand and intimate.
                            </p>
...
Ancient Symbolism of Strength
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
In many traditions, basalt symbolizes stability, strength, and resilience—qualities that resonate with the land of Gujarat itself. Guests often share that their stay feels “anchored,” as if the very walls hold a quiet wisdom. This isn’t just architecture; it’s emotional design rooted in centuries of respect for stone.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
...
Wellness Beyond the Spa
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Whether it’s the basalt meditation corners, the garden seating carved from stone, or the quiet pools edged with natural rock, the material keeps appearing—subtly guiding guests back into presence. Even without noticing, you’re supported by stone’s steadying energy throughout your stay.                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
At Basalt, silence isn’t empty. It’s full of music.
                            </p> */}
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                       <h1 className="text-[18px] flex items-center gap-[10px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                         <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
                          Why Basalt Matters at Basalt Paradise
                        </h1>
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={FlyingBird1}
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
                             Basalt is not decoration—it’s philosophy. It embodies the idea that well-being doesn’t come only from treatments, but from the environment itself. At this resort, stone is both structure and soul, shaping wellness in ways you can feel but not always see.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
