...
export default function WellTravel() {
...
Guests recommend packing outfits that can move from day to night with small tweaks. A breezy kurta, a cotton dress, or well-cut trousers work for breakfast by the pool, afternoon walks, and even candlelit dinners with just a change of accessories. Lightweight layers are your best friend for Halol’s shifting temperatures.
                            </p>
...
Let Nature Style You
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Basalt Paradise is surrounded by serene landscapes, so you don’t need a suitcase of heavy accessories. Guests say a scarf, a sun hat, and one pair of sandals are often all you need. Nature’s backdrop does the rest—whether it’s monsoon greenery, winter sunshine, or starlit skies.
</p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
...
Travel-Size Comforts Only
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Instead of full bottles of skincare and haircare, pack travel-size essentials. Many guests also note that the resort provides thoughtful amenities, so there’s no need to carry more than your basics. The lighter your toiletry kit, the quicker you can unpack and start relaxing.
                            </p>
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
Pack for Memories, Not For “What Ifs”
                     </h1>
                        {/* Hero Banner */}
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
One of the best guest tips is to leave the “just in case” items behind. You don’t need five pairs of shoes or bulky gear. Instead, keep a little space in your bag for souvenirs—like local handicrafts, handmade teas, or pottery—things that carry a piece of Halol home with you.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
...
Mindful Add-Ons
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Bring a journal, a good book, or a deck of cards. These little items create meaningful moments during your stay—whether it’s writing by the garden, reading in a hammock, or playing a quiet game by the bonfire.
</p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
At Basalt, silence isn’t empty. It’s full of music.
                    ...
                    <div className=" w-[100%]">
                       <h1 className="text-[18px] flex items-center gap-[10px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                         <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
Why Packing Light Matters Here
                        </h1>
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={FlyingBird1}
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Guests often share that when they travel lighter, they feel freer. At Basalt Paradise, the less you carry, the more you notice—the songs of birds, the sway of bamboo, the feel of stone pathways under your feet. With lighter bags, your days feel unhurried, and your nights more restful.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
