...
export default function TopWaterfall() {
    ...
    <>
      ...
      <div className="  2xl:w-[1300px] font-Poppins !bg-[#] w-[90%] md:w-[80%]   h-[100%] mx-auto px-2 py-8 gap-[20px] pt-[110px] flex ">
        <div className=" md:w-[80%] gap-[40px] flex flex-col">
          <div className=" w-[100%]">
            ...
            <article className="space-y-2">
              ...
              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]">Location: </b>Near
                Poyali village, ~45 km from Halol{" "}
              </div>

              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]">Best Time: </b> July to
                September
              </div>

              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]">How to Reach: </b>{" "}
                Drive towards Jambughoda → turn at Poyali village
              </div>

              <div className="flex-shrink gap-[10px]">
                <b className="font-[600] mr-2 text-[#7442ff]">Why Visit:</b>
                Arguably the most popular waterfall in central Gujarat, Hathni
                Mata offers a towering cascade surrounded by dense forests.
                Ideal for photography, picnics, or even light trekking.
              </div>

              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]">Tip:</b>Weekends can
                get crowded — arrive early or visit on a weekday morning.
              </div>

              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]">Interlink: </b> Check
                out Best Nature Spots Near Halol →
              </div>
            </article>
          </div>
          ...
          <div className=" w-[100%]">
            <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
              Jambughoda Waterfall (inside Jambughoda Wildlife Sanctuary)
            </h1>
            {/* <div className=' cursor-default mb-[10px] flex items-center gap-[10px]   text-[#7442ff] '>
                            <i className="fa-regular text-[20px ] fa-location-dot"></i>
                            <p className=' gap-[10px] mt-[2px] flex'>
            ...
            <article className="space-y-2">
              ...
              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]">Location: </b>40 km
                from Halol
              </div>

              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]">Best Time: </b>{" "}
                Mid-July to Late September
              </div>

              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]"> Entry Fee: </b>{" "}
                Nominal wildlife entry charges apply
              </div>

              <div className="flex-shrink gap-[10px]">
                <b className="font-[600] mr-2 text-[#7442ff]">Why Visit:</b> Set
                within a wildlife reserve, this spot is a dream come true for
                monsoon trekkers. The gurgling stream winds through rocky trails
                with occasional sightings of peacocks, langurs, and birds.
              </div>

              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]">Tip:</b>Carry
                water-resistant shoes and a change of clothes.
              </div>
            </article>
          </div>
          <span className=" flex w-[50%] ml-[] border-t-[1.7px] border-[#7442ff]  border-dashed "></span>
          ...
          <div className=" w-[100%]">
            ...
            <article className="space-y-2">
              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]">Location: </b>Near
                Ghodia, ~18 km from Halol
              </div>

              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]">Best Time: </b>{" "}
                July–August (depends on rainfall)
              </div>

              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]"> How to Reach:</b>{" "}
                Offbeat path – ask locals near Ghodia village{" "}
              </div>

              <div className="flex-shrink gap-[10px]">
                <b className="font-[600] mr-2 text-[#7442ff]">Why Visit:</b>This
                is one of the least explored, hidden gems. When the monsoon is
                generous, the overflow forms a temporary cascading stream over
                the rocks.
              </div>

              <div className="flex gap-[10px]">
                <b className="font-[600] text-[#7442ff]">Perfect for: </b>
                Peaceful getaways, photography, or a serene bike ride.
              </div>
            </article>
          </div>
          ...
          <div className=" w-[100%]">
            <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
              Kadiya Dungar Streams (local favorite)
            </h1>
            ...
            <article className="space-y-2">
              ...
              <div className="">
                <b className="font-[600] text-[#7442ff]"> Where:</b> 8–10 km
                from Pavagadh base, hill-side paths
              </div>
              <div className="">
                <b className="font-[600] text-[#7442ff]"> Best Time:</b> Peak
                monsoon season
              </div>
              <div className="">
                <b className="font-[600] text-[#7442ff]"> Why Visit:</b> During
                heavy rains, the terrain around Kadiya Dungar (south of Pavagadh
                hill) forms multiple streamlets and mini-falls. If you're
                staying nearby (like at Basalt Paradise), ask staff for
                directions to the best temporary falls!
              </div>
            </article>
          </div>
          ...
          <div className=" w-[100%]">
            ...
            <article className="space-y-2">
              ...
              <li>
                Always wear good grip trekking shoes or waterproof sandals
              </li>
              <li>
                Avoid visiting right after a heavy downpour — flash floods or
                slippery rocks are risky
              </li>
              <li>Do not litter — carry your trash back </li>
              <li>Carry a dry bag for electronics</li>
            </article>
          </div>
          ...
          <div className=" w-[100%]">
            <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
              Stay Close to the Falls: Basalt Paradise
            </h1>
            {/* Hero Banner */}
            <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
              <img
            ...
            <article className="space-y-2">
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                Located in a tranquil part of Halol, Basalt Paradise offers a
                cozy stay with quick access to all these natural escapes. The
                greenery, misty views, and monsoon breeze will make your stay
                magical.
      ...
      <StarBorder
                  ...
                  as="button"
                  className="custom-class rounded-[9px]"
                  color="#00FFFF"
                  speed="5s"
                >
                  Book Now
          ...
          <div className=" w-[100%]">
            ...
            <article className="space-y-2">
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                Monsoon breathes new life into Pavagadh and Halol — and these
                waterfalls are living proof. Take a break from the routine, put
                on your trekking shoes, and discover the natural magic just
                outside your window.
              </p>
              {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
            ...
            <ul className="list-disc ml-4 text-[17px] space-y-2">
              ...
              <li>
                <a
                  ...
                  className="text-[#000000] font-[500] hover:underline"
                >
                Day Trip Itinerary from Vadodara
                </a>
              </li>
              <li>
                <a
                  href="/blogs/adventure-activities"
                  className="text-[#000000] font-[500] hover:underline"
                >
              Adventure Activities Around Basalt Paradise
                </a>
              </li>
            </ul>
          </div>
