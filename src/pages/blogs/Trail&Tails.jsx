...
export default function TrailTails() {
...
The Old Banyan Path – A Living Legend                        </h1>
...
Just a few minutes from the villas lies a trail leading to a sprawling banyan tree, believed by locals to be over a century old. Villagers say gatherings once took place here, where storytellers passed down tales of Halol’s kings and warriors. Today, it still feels like a gathering space—perfect for meditation or journaling under its giant branches.
                            </p>
...
The Forgotten Shrine Walk
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
A trail carved into the rocky edges leads to a small, stone shrine. It’s weathered, quiet, and often unnoticed unless you slow down. Locals tell of travelers stopping here for blessings before long journeys. For modern explorers, it’s a soulful pause—proof that even in forgotten corners, history whispers.                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    The Monsoon Meadow Loop
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
During the rains, a short meadow trail transforms into a living carpet of wildflowers, butterflies, and buzzing bees. Guests love walking here in the early morning when mist hugs the ground and the air smells of wet earth. Each bloom feels like a story of resilience, painting the landscape in fleeting colors.
                            </p>
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
The Market Road Memory Lane                        </h1>
                        {/* Hero Banner */}
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={praragavhill1}
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Not all trails are in the wild. A short walk toward Halol’s old bazaar brings you into the heart of culture—where brassware clinks, spices perfume the air, and locals greet you with warm smiles. This is a trail of trade and tradition, one that shows how Halol’s spirit is tied to its people.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
...
Why These Walks Matter
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
At Basalt Paradise, walks aren’t just about steps—they’re about stories. Each trail, whether shaded by banyan roots or lit by market lanterns, ties you closer to Halol’s identity. You return not just refreshed, but enriched—with small stories to carry home.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
