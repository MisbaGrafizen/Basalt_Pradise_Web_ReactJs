...
export default function QuiteCorners() {
...
By the Water Feature: Flowing Calm
</h1>
...
The soft sound of trickling water creates a natural rhythm for reflection. Guests often choose these stone-lined water features as their personal “thinking spot.” It’s perfect for reading, sketching, or simply letting your gaze follow the ripples as the world slows down around you.
                            </p>
...
Beneath the Ancient Trees
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Scattered across the resort’s gardens are trees whose canopies create little sanctuaries of shade. Sit beneath them with a notebook or simply rest in silence. The breeze carries whispers of leaves overhead, making these spots ideal for quiet meditation or grounding breaths.
</p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                        <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] flex items-center gap-[10px] text-gray-900">
                            <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
             Shaded Alcoves and Stone Benches
                        </h1>
                        {/* Hero Banner */}
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Hidden along pathways and near courtyards, basalt benches offer restful pauses. Their cool surface and shaded placement make them perfect during the warmth of the day. Many guests enjoy journaling here, using the play of light and shadow as creative inspiration.
                            </p>
...
Hammocks and Garden Retreats
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
Some corners are designed for doing nothing at all—like the hammocks tucked between trees or secluded garden seating. These spaces embody the art of slowing down, reminding you that rest is as valuable as activity.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
                    ...
                    <div className=" w-[100%]">
                      <h1 className="text-[18px] flex items-center gap-[10px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
                         <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
Quiet by Night: Stars and Silence
                        </h1>
                        {/* <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
                            <img
                                src={FlyingBird1}
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
As evening falls, the quiet corners transform. What felt like reading nooks by day become stargazing lounges at night. With minimal light pollution in Halol, the skies above Basalt Paradise offer their own storybook—best read with the naked eye.
</p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
...
Why Quiet Matters Here
                        ...
                        <article className="space-y-2">
                            ...
                            <p className="text-gray-600 md:text-[16px] text-[14px]">
In today’s world of constant notifications, quiet has become rare. At Basalt Paradise, it’s part of the experience. These corners are more than seating—they’re invitations to simply “be,” whether with a novel, a sketchpad, or your own untethered thoughts.
                            </p>
                            {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
