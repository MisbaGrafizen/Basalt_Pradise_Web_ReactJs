        ...
        <div className=" md:w-[80%] gap-[40px] flex flex-col">
          <div className=" w-[100%]">
            ...
            <article className="space-y-2">
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                <li>Honest Restaurant, Halol</li>
                <li>Mandap Dining Hall, Hotel Yuvraj (Halol)</li>
                <li>Jay Bhole Kathiyawadi near Pavagadh foothills</li>
              </p>
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                <li>Rotla (millet flatbread), Bajra roti</li>
                <li>Sev tameta (spicy tomato curry), Bhindi masala</li>
                <li>Kadhi, khichdi, dal fry</li>
                <li>Chaas (buttermilk), salad, papad</li>
              </p>
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                Wholesome, flavorful, and incredibly filling — a must-have if
          ...
          <div className=" w-[100%]">
            ...
            <article className="space-y-2">
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                <li>Dhokla, Khandvi, Patra</li>
                <li>Ganthiya with fried chillies</li>
                <li>Fafda-jalebi (especially on weekends!)</li>
              </p>

              <div className="!mt-[10px]">
                <b className="font-[600]  text-[#7442ff]">Local tip:</b>Try Laxmi Snacks near Halol Bus Stand for fresh morning farsan or evening snacks.
                <br /></div>
          ...
          <div className=" w-[100%]">
            ...
            <article className="space-y-2">
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                <li>Sev Usal (spicy gravy dish with crunchy sev on top)</li>
                <li>Bhajiya & Tea stalls around Halol Circle</li>
                <li>Roadside stalls near Pavagadh foothills serve corn-on-the-cob, boiled chana, masala soda</li>
              </p>
              <div className="!mt-[10px]">
          ...
          <div className=" w-[100%]">
            ...
            <article className="space-y-2">
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                <li>Saurashtra Kathiyawadi Bhojanalay near Machi</li>
                <li>Jay Gurudev Kathiyawadi, Halol</li>
              </p>
              <div className="!mt-[20px]"></div>
              <h1 className="text-[18px] md:text-[23px] gap-[10px] flex  items-center font-[500] text-gray-900">
                <i className="fa-solid text-[13px] text-[#7442ff] fa-circle"></i>
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                <li>Spicy garlic curries, ringna no olo (mashed roasted eggplant), lasaniya batata (garlicky potatoes), served with bajra rotla and white butter.</li>
                <li>Perfect for chilly evenings post-temple trek!</li>
          ...
          <div className=" w-[100%]">
            ...
            <article className="space-y-2">
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                <li>Mohanthal</li>
                <li>Penda (especially from Anand Sweets, Halol)</li>
                <li>Mango or Sitaphal (custard apple) ice cream during season</li>
              </p>
          ...
          <div className=" w-[100%]">
            <h1 className="text-[18px] mb-[10px] md:text-[27px] font-[600] text-gray-900">
              Where to Stay After a Hearty Meal
            </h1>
            {/* Hero Banner */}
            <div className="relative w-full md:h-[400px] h-[200px] mb-3 bg-[#0a192f] rounded-lg overflow-hidden">
              <img
            ...
            <article className="space-y-2">
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                <p className="text-gray-600 md:text-[16px] text-[14px]">
                  Basalt Paradise is perfectly located between these viewpoints —
                  close enough for sunrise treks, yet peaceful for starry nights.
                  Book your nature retreat here →
          ...
          <div className=" w-[100%]">
            ...
            <article className="space-y-2">
              ...
              <p className="text-gray-600 md:text-[16px] text-[14px]">
                From rustic roadside dishes to authentic Gujarati feasts, the food scene around Halol and Pavagadh offers more than just fuel — it delivers culture, comfort, and flavor. Don’t forget to bring back some mithai as a sweet souvenir!
              </p>
              {/* <p className="text-gray-600 md:text-[16px] text-[14px]">
            ...
            <ul className="list-disc ml-4 text-[17px] space-y-2">
              ...
              <li>
                <a
                  ...
                  className="text-[#000000] font-[500] hover:underline"
                >
                  What to Do in One Day – Vadodara to Pavagadh
                </a>
              </li>
              <li>
                <a
